...
const savesTab = document.getElementById('savesTab');

const contentLeft = document.getElementById('contentLeft');
const contentRight = document.getElementById('contentRight');
const contentSaves = document.getElementById('contentSaves');

const savesTable = document.getElementById('savesTable');
...
const boxSizeWidth = 120; // Adjust as needed
const boxSizeHeight = 120; // Adjust as needed
...
function loadSavesTab() {
	
}

savesTab.addEventListener('click', () => {
  loadSavesTab();
});
...
function loadContentForSelectedImage(selectedInt) {
	...
	document.getElementById('selectedURL').textContent = `${selectedAlpha}`;

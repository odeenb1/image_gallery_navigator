...
async function getGalleryImageURL(curInt) {
	...
	const calc_url = `/getFirstImage?url=https://pixhost.to/gallery/${curAlpha}`;
...
function saveAllImages() {
	...
	const save_url = `/saveImages?url=https://pixhost.to/gallery/${selectedAlpha}&${options}`;
	fetch(save_url)
...
function displayAllImages(selectedInt) {
	...
	calc_url = `/getImages?url=https://pixhost.to/gallery/${selectedAlphanumeric}&${calc_options}`;

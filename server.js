...
app.get('/saveImages', async (req, res) => {
    ...
    try {
        ...
        if (response.status === 200) {
            ...
            const subdirectory = path.join(__dirname, 'images', currentAlphanumeric);
...
app.get('/getImages', async (req, res) => {
    ...
    try {
        ...
        if (response.status === 200) {
			//const alphanumericValue = integerToAlphanumeric(currentInteger); // Calculate the alphanumeric value
